...
- Cloudflare Worker `quote-api`: KIS 인증/토큰 캐시, 시세·일봉·계좌·주문내역 조회, reconciliation, DRY_RUN 시뮬레이터, Risk Manager, Kill Switch, PAPER 주문/취소/재동기화, 전략 3종(SMA 교차+추세 필터·절대 모멘텀·변동성 돌파)·트레일링 스탑·백테스트, Cron 자동매매 엔진(DRY_RUN/PAPER), 감사 로그·알림, 실계좌 게이트(기본 비활성)
